      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          {state.items.map(item => (
            <div key={item.id} className="flex justify-between items-center py-2 border-b last:border-b-0 border-gray-100">
              <div>
          ...
          <div className="flex justify-between items-center pt-4 border-t mt-4 border-gray-100">
